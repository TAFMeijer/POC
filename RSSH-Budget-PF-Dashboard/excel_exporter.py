...
def build_excel_export(n_clicks, region, country, ip, component):
    ...
    b_filt, i_filt, w_filt = filter_data(region=region, country=country, ip=ip, component=component)
    ...
    df_sheet2 = (b_filt[['Country', 'Module Parent Component', 'Module', 'Intervention', 'Total Amount']]
                 .groupby(['Country', 'Module Parent Component', 'Module', 'Intervention'])['Total Amount']
                 .sum().reset_index())
    ...
    df_sheet3 = i_filt[['Country', 'Implementation Period Name', 'Module Parent Component',
                        'Module', 'IndicatorType', 'IsCustom', 'IndicatorCode',
                        'IndicatorCustomName', 'IndicatorDescription']].copy()
    ...
    group_cols = ['Country', 'Module Parent Component', 'Module', 'IndicatorType',
                  'IsCustom', 'IndicatorCode', 'Indicator Name', '__sort_order', '__sort_code']
    ...
    # ── SHEET 4: WPTM List ─────────────────────────────────────────────────
    df_sheet4 = (w_filt[['Country', 'Module Parent Component', 'Module', 'KeyActivity']]
                 .groupby(['Country', 'Module Parent Component', 'Module', 'KeyActivity'], dropna=False)
